...
class no_year3:
    def __init__(self):
        ...
        # 6、流动性分析
        self.s2d6 = \
            "申请人近三年及最近一期流动比率分别为{流动比率2:.2%}、{流动比率1:.2%}和{流动比率m:.2%}，平均值为{流动比率av:.2%}，" \
            "较年初变化{流动比率delta}个百分点；" \
            "申请人近三年及最近一期速动比率分别为{速动比率2:.2%}、{速动比率1:.2%}和{速动比率m:.2%}，平均值为{速动比率av:.2%}，" \
            "较年初变化{速动比率delta}个百分点。" \
            "【请根据实际情况自行评价】。"  # 12个变量
...
class all_years:
    def __init__(self):
        ...
        # 6、流动性分析
        self.s2d6 = \
            "申请人近三年及最近一期流动比率分别为{流动比率3:.2%}、{流动比率2:.2%}和{流动比率1:.2%}，三年平均值为{流动比率av:.2%}，" \
            "较年初变化{流动比率delta:.2f}个百分点；" \
            "申请人近三年及最近一期速动比率分别为{速动比率3:.2%}、{速动比率2:.2%}和{速动比率1:.2%}，三年平均值为{速动比率av:.2%}，" \
