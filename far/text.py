...
class normal:
    def __init__(self):
        ...
        self.s2d4_dict = {'净现金流入3':float(), '净现金流入2':float(), '净现金流入1':float(),
...
class no_year3:
    def __init__(self):
        ...
        self.s2d4 = \
            ...
            "总体来看，申请人盈利能力【请根据实际情况自行评价】"  # 16个变量
        self.s2d4_dict = {'净现金流入2':float(), '净现金流入1':float(),
                          '经营活动现金净流入2':float(), '经营活动现金净流入1':float(),
                          '投资活动现金净流入2':float(), '投资活动现金净流入1':float(),
                          '筹资活动现金净流入2':float(), '筹资活动现金净流入1':float(),
                          }
